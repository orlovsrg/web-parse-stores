...
//        System.out.println(lidt);
        ...
        String title = "НОУТБУК HP PROBOOK 450 G7 PIKE SILVER (6YY28AV_V14)";
...
//        }
        System.out.println(title.toLowerCase().startsWith("ноутбук"));
...
//            System.out.println(title.replaceAll(" {2,}", " ").trim());
//        } else if (title.startsWith("ноутбук")) {
//            if (title.lastIndexOf(")") > 0 && title.lastIndexOf(")") != title.length() - 1) {
//                title = title.replaceAll("[а-яА-Я]", "");
//                String part = title.substring(title.lastIndexOf("("), title.lastIndexOf(")") + 1);
//                title = title.replace(part, "");
